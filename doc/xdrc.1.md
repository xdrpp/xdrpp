...
documented in Section 12.2 of RFC5531), `xdrc` generates C++ struct of
the same name.  As a consequence, versions should use unique names.
...
* `call_dispatch(t, procno, a1, a2, ...)` - calls the templae method
